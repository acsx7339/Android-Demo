...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button0 = (Button)findViewById(R.id.celebChosen);
        button1 = (Button)findViewById(R.id.celebChosen2);
        button2 = (Button)findViewById(R.id.celebChosen3);
        button3 = (Button)findViewById(R.id.celebChosen4);
    ...
    public void createQuestion(){
        ...
        try {
            ...
            for (int i = 0;i<4;i++){
                ...
                }else {incorrectAnswerLocation = random.nextInt(celebURLs.size());
